...
!(function (t, e) {
    ...
    return (
      ...
      (t.to = function (t) {
        ...
        if (!(t > this._items.length - 1 || t < 0))
          if (this._isSliding) p(this._element).one(q.SLID, () => e.to(t));
          else {
            ...
            p(s)
              .one(m.TRANSITION_END, () => {
                p(l).removeClass(`${n} ${i}`).addClass(Q),
                  ...
                  (r._isSliding = !1),
                  setTimeout(() => p(r._element).trigger(u), 0);
              })
        ...
        if (
          ...
          (this._parent &&
            (t = [].slice
              ...
              .filter((t) =>
                typeof n._config.parent === "string"
  ...
  function fe(t, e, n) {
    ...
    const o =
      !!i && t.some((t) => t.name === n && t.enabled && t.order < i.order);
    if (!o) {
      const r = `\`${e}\``;
      const s = `\`${n}\``;
      console.warn(
  ...
  function ye(t, o, r, e) {
    ...
    const i = n.indexOf(ne(n, (t) => t.search(/,|\s/) !== -1));
    n[i] &&
      n[i].indexOf(",") === -1 &&
      console.warn(
    ...
    function r(t, e) {
      ...
      !(function (t, e) {
        ...
        (this.modifiers = Object.keys(this.options.modifiers)
          .map((t) => ({ name: t, ...n.options.modifiers[t] }))
    ...
    return (
      ...
      (t._setListeners = function () {
        ...
        this.config.trigger.split(" ").forEach((t) => {
          if (t === "click")
            p(i.element).on(i.constructor.Event.CLICK, i.config.selector, (t) =>
              i.toggle(t)
            );
          else if (t !== Bn) {
            const e =
