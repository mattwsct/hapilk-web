      ...
      _proto._removeElement = function _removeElement(element) {
        ...
        $(element)
          .one(Util.TRANSITION_END, (event) =>
            _this._destroyElement(element, event)
          )
    ...
    (function () {
      ...
      _proto._addEventListeners = function _addEventListeners() {
        ...
        if (this._config.pause === "hover") {
          $(this._element)
            .on(Event$2.MOUSEENTER, (event) => _this2.pause(event))
            .on(Event$2.MOUSELEAVE, (event) => _this2.cycle(event));
        }
    ...
    (function () {
      ...
      _proto.hide = function hide(event) {
        ...
        if (transition) {
          ...
          $(this._element)
            .one(Util.TRANSITION_END, (event) => _this2._hideModal(event))
            .emulateTransitionEnd(transitionDuration);
        } else {
          this._hideModal();
        }
      ...
      _proto._setListeners = function _setListeners() {
        ...
        triggers.forEach((trigger) => {
          if (trigger === "click") {
            ...
            $(_this4.element)
              .on(eventIn, _this4.config.selector, (event) =>
                _this4._enter(event)
              )
              .on(eventOut, _this4.config.selector, (event) =>
                _this4._leave(event)
              );
          }
        });
