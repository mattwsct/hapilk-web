...
!(function (e, t) {
  ...
  function C(e, t, n) {
    let r;
    let i;
    const o = (n = n || v).createElement("script");
    if (((o.text = e), t))
      for (r in c)
  ...
  const h = (function (n) {
    ...
    const M = `\\[${R}*(${B})(?:${R}*([*^$|!~]?=)${R}*(?:'((?:\\\\.|[^\\\\'])*)'|"((?:\\\\.|[^\\\\"])*)"|(${B}))|)${R}*\\]`;
    const W = `:(${B})(?:\\((('((?:\\\\.|[^\\\\'])*)'|"((?:\\\\.|[^\\\\"])*)")|((?:\\\\.|[^\\\\()[\\]]|${M})*)|.*)\\)|)`;
    const $ = new RegExp(`${R}+`, "g");
    const F = new RegExp(`^${R}+|((?:^|[^\\\\])(?:\\\\.)*)${R}+$`, "g");
    ...
    const Z = /^(?:#([\w-]+)|(\w+)|\.([\w-]+))$/;
    const ee = /[+~]/;
    const te = new RegExp(`\\\\([\\da-f]{1,6}${R}?|(${R})|.)`, "ig");
          ...
          if (!a) {
            ...
            (a = k(
              ...
              (r = function (e, t, n, r, i) {
                ...
                const h = (A += d == null ? 1 : Math.random() || 0.1);
                const g = p.length;
                for (
                  i && (w = t === T || t || i);
                  l !== g && (o = p[l]) != null;
  ...
  (E.event = {
    ...
    dispatch(e) {
      ...
      const l = (G.get(this, "events") || {})[s.type] || [];
  ...
  const Me = new RegExp(`^(${te})(?!px)[a-z%]+$`, "i");
  const We = function (e) {
    let t = e.ownerDocument.defaultView;
    return (t && t.opener) || (t = g), t.getComputedStyle(e);
  };
  const $e = new RegExp(re.join("|"), "i");
  function Fe(e, t, n) {
    let r;
    let i;
    let o;
  ...
  const Ue = v.createElement("div").style;
  const Ve = {};
  function Xe(e) {
    const t = E.cssProps[e] || Ve[e];
    return (
      t ||
      (e in Ue
        ? e
      ...
      n === "margin" && (u += E.css(e, n + re[a], !0, i)),
        r
          ? (n === "content" && (u -= E.css(e, `padding${re[a]}`, !0, i)),
            n !== "margin" && (u -= E.css(e, `border${re[a]}Width`, !0, i)))
  ...
  E.extend({
    ...
    E.each(["height", "width"], (e, u) => {
      E.cssHooks[u] = {
        ...
        set(e, t, n) {
          let r;
          const i = We(e);
          const o = !b.scrollboxSize() && i.position === "absolute";
          const a = (o || n) && E.css(e, "boxSizing", !1, i) === "border-box";
          let s = n ? tt(e, u, n, a, i) : 0;
          return (
            a &&
              o &&
              (s -= Math.ceil(
    ...
    (E.cssHooks.marginLeft = ze(b.reliableMarginLeft, (e, t) => {
      if (t)
        return `${
  ...
  const ot = /^(?:input|select|textarea|button)$/i;
  const at = /^(?:a|area)$/i;
  function st(e) {
  ...
  E.fn.extend({
    ...
    E.fn.extend({
      ...
      hasClass(e) {
        ...
        t = ` ${e} `;
        while ((n = this[r++]))
          if (n.nodeType === 1 && ` ${st(ut(n))} `.indexOf(t) > -1) return !0;
        return !1;
      },
    });
  const ct = /\r/g;
  ...
  E.extend(E.event, {
    trigger(e, t, n, r) {
      ...
      let f;
      const d = [n || v];
      let p = m.call(e, "type") ? e.type : e;
      let h = m.call(e, "namespace") ? e.namespace.split(".") : [];
      if (
        ((o = f = a = n = n || v),
        n.nodeType !== 3 &&
          n.nodeType !== 8 &&
  ...
  const ht = /\[\]$/;
  const gt = /\r?\n/g;
  const vt = /^(?:submit|button|image|reset|file)$/i;
  const yt = /^(?:input|select|textarea|keygen)/i;
  function mt(n, e, r, i) {
    let t;
    if (Array.isArray(e))
      E.each(e, (e, t) => {
        r || ht.test(n)
          ? i(n, t)
          : mt(`${n}[${typeof t === "object" && t != null ? e : ""}]`, t, r, i);
      });
  ...
  (E.param = function (e, t) {
    ...
    E.each(["top", "left"], (e, n) => {
      E.cssHooks[n] = ze(b.pixelPosition, (e, t) => {
        if (t)
